    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.trys.push([5, 7, , 9]);
                    return [4 /*yield*/, applyBlock.bind(this)(block, opts.skipBlockValidation)];
                case 6:
                    result = _a.sent();
                    return [3 /*break*/, 9];
                case 7:
 ...
 */
function applyBlock(block, skipBlockValidation) {
    if (skipBlockValidation === void 0) { skipBlockValidation = false; }
    return __awaiter(this, void 0, void 0, function () {
        var txResults;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!skipBlockValidation) return [3 /*break*/, 3];
 ...
 * @param {Block} block
 */
function applyTransactions(block) {
    return __awaiter(this, void 0, void 0, function () {
