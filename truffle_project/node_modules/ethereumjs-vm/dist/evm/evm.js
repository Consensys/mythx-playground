                ...
                switch (_b.label) {
                    ...
                    case 9:
                        ...
                        if (totalGas.lte(message.gasLimit) &&
                            ...
                            result = __assign({}, result, OOGResult(message.gasLimit));
                        }
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (interpreterRes.exceptionError) {
                            ...
                            result = __assign({}, result, { logs: [], selfdestruct: {} });
                            // Revert gas refund if message failed
                            this._refund = oldRefund;
                        }
                        return [2 /*return*/, __assign({}, result, { runState: __assign({}, interpreterRes.runState, result, eei._env), exceptionError: interpreterRes.exceptionError, gas: eei._gasLeft, gasUsed: gasUsed, returnValue: result.returnValue ? result.returnValue : Buffer.alloc(0) })];
                }
            });
        });
    };
