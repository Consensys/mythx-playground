...
describe('mythx.js', () => {
  it('should turn truffle contract json to mythx compatible object', done => {
    ...
    fs.readFile(
      ...
      (err, data) => {
        ...
        const mythXJSON = mythx.truffle2MythXJSON(
          contracts[0],
          'test-truffle-analyze'
        );

        assert.deepEqual(mythXJSON, {
          contractName:
            truffleJSON.sources[solFilePath].contracts[0].contractName,
          bytecode: truffleJSON.sources[solFilePath].contracts[0].bytecode,
          deployedBytecode:
            truffleJSON.sources[solFilePath].contracts[0].deployedBytecode,
  ...
  it('should remap MythX Output object to array grouped by sourceLocation', () => {
    const mythXOutput = {
      ...
      sourceFormat: 'text',
      sourceList: ['/tmp/contracts/sol1.sol'],
      issues: [
        {
          locations: [
            { sourceMap: '0:23:0', sourceList: ['/tmp/contracts/sol1.sol'] },
          ],
          swcID: 'SWC-103',
          ...
          description: {
            ...
            tail:
              'It is recommended to make a conscious choice on what version of Solidity is used for compilation. Currently any version equal or grater than "0.5.0" is allowed.',
          },
          severity: 'Low',
          extra: {},
        },
        {
          locations: [
            { sourceMap: '400:19:0', sourceList: ['/tmp/contracts/sol1.sol'] },
          ],
          swcID: 'SWC-109',
          ...
          description: {
            ...
            tail:
              'Uninitialized storage variables of user-defined type can point to unexpected storage locations. Initialize variable "upgraded" or set the storage attribute "memory".',
          },
          severity: 'Low',
          extra: {},
        },
